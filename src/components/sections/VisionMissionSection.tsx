...
export default function VisionMissionSection() {
  ...
  return (
    <section className="relative w-full bg-white py-16 sm:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-20 w-64 h-64 bg-orange-400/5 rounded-full blur-[80px] -z-10" />
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <motion.div variants={itemVariants} className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[#FF6B00] font-black uppercase tracking-[0.3em] text-[10px] sm:text-xs">
              Visi & Misi Kami
            </span>
          </motion.div>

          <motion.h2 variants={itemVariants} className="text-4xl sm:text-5xl lg:text-5xl xl:text-5xl 2xl:text-6xl font-black text-[#020617] leading-[1.05] mb-10 sm:mb-12 tracking-tighter">
            Target <br />
          ...
          <motion.div 
            ...
            className="mb-12 p-8 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] bg-[#050A1F] text-white relative overflow-hidden group shadow-[0_30px_60px_-15px_rgba(5,10,31,0.4)]"
          >
            {/* Abstract Shapes */}
            ...
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#FF6B00]/20 rounded-tr-[4rem] blur-xl" />

            <div className="relative z-10">
              <div className="flex items-center gap-5 mb-8">
                 <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:border-[#FF6B00]/50 group-hover:bg-[#FF6B00]/10 transition-all duration-300">
                    <RiEye2Line className="text-3xl text-[#FF6B00]" />
                 </div>
                 <div>
                   <h3 className="text-xs font-black tracking-[0.2em] uppercase text-white/50 mb-1">Visi Institusi</h3>
                   <div className="h-[2px] w-12 bg-[#FF6B00]/50" />
                 </div>
              </div>
          ...
          >
             {missions.map((item, i) => (
                ...
                >
                  <div className="flex-shrink-0 w-12 h-12 rounded-2xl border-2 border-[#FF6B00]/20 flex items-center justify-center text-[#FF6B00] bg-white group-hover:bg-[#FF6B00] group-hover:text-white transition-all duration-300 shadow-lg shadow-[#FF6B00]/5 mt-1">
                    <item.icon className="text-xl transition-transform group-hover:scale-110" />
                  </div>
                  <div className="pt-2">
                    <h4 className="text-[#020617] font-bold text-base sm:text-lg leading-relaxed group-hover:text-[#FF6B00] transition-colors">
                      {item.text}
                    </h4>
                  </div>
                </motion.div>
        ...
        <div className="relative lg:h-full w-full flex items-center justify-center mt-10 lg:mt-0">
          ...
          >
            <div className="relative z-10 rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden shadow-2xl bg-[#050A1F]/5 p-3 sm:p-4 border border-gray-100">
               <Image
            ...
            <motion.div 
              ...
              className="absolute top-8 sm:top-16 -left-2 sm:-left-8 bg-white shadow-[0_20px_50px_-10px_rgba(0,0,0,0.1)] p-5 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] border-l-4 border-[#FF6B00] z-20"
            >
               <div className="flex flex-col">
                  <span className="text-3xl sm:text-4xl font-black text-[#020617]">A+</span>
            ...
            <motion.div 
              ...
              className="absolute bottom-8 sm:bottom-16 -right-2 sm:-right-8 bg-[#FF6B00] shadow-[0_20px_50px_-10px_rgba(255,107,0,0.3)] p-5 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] z-20"
            >
            ...
            {/* Decoration */}
            <div className="absolute -top-10 -right-10 w-64 h-64 bg-[#FF6B00]/10 rounded-full blur-3xl -z-10" />
